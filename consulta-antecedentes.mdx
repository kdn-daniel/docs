...
<Note>
  `FechaExpedicionDocumentoIdentidad` es opcional. Si no la envías, la solicitud igual se crea, pero **algunas fuentes no se consultan**. Otras no la necesitan. El listado de fuentes y cuáles piden la fecha está en la web de ECORPA.
</Note>
...
<div className="result-info-cards">
  <CardGroup cols={2}>
    ...
    <Card title="Fuentes y fecha de expedición" icon="calendar">
      Sin `FechaExpedicionDocumentoIdentidad` no se consultan algunas fuentes. Cuáles la piden, cuáles no y el listado de fuentes está en la web de ECORPA.
    </Card>
  </CardGroup>
</div>
